...
- [ ] Gameplay:
    * nerd costume playing talk animation
    * nerd computer hangs
    * nerd animation on windows hangs
    * nerd playing animation move mouse and keyboard
    ...
    * take animation and position costumes to nerd
