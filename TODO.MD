...
- [ ] Gameplay:
    * more contrast on ms-dos letters on run computer
	* open oat box inventory oat dry?
	* cassette sound on stereo?
	* sound of cassette playing?
	* bug on street: click GO and when moving, click GO to JUMP Store	
